...
class UserHandle extends StatefulWidget {
  const UserHandle({Key? key}) : super(key: key);

  @override
  State<UserHandle> createState() => _UserHandleState();
}

class _UserHandleState extends State<UserHandle> {
                          ...
                          child: Dismissible(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: Colors.green.shade50, // Add background color to the container
                              ),
                              child: ListTile(
